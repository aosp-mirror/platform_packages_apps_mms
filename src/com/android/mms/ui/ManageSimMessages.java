...
public class ManageSimMessages extends Activity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Intent it = getIntent();
        // add for MSim
        mSubId = it.getIntExtra(PhoneConstants.SUB_ID_KEY, 0);
    ...
    private void startQuery() {
        try {
            // Add 'sub_id' for MSim.
            Uri simUri = ICC_URI.buildUpon().appendQueryParameter(PhoneConstants.SUB_ID_KEY,
    ...
    private void deleteFromSim(Cursor cursor) {
        ...
        Uri simUri = ICC_URI.buildUpon().appendPath(messageIndexString).appendQueryParameter(
                PhoneConstants.SUB_ID_KEY, String.valueOf(mSubId)).build();
