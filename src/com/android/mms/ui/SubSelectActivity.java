...
public class SubSelectActivity extends ListActivity {
    ...
    private void setAdapter(){
        mSubInfoList = SubscriptionController.getActivatedSubInfoList(this);
    ...
    public void startManageSimMessages(int position) {
        ...
        it.putExtra(PhoneConstants.SUB_ID_KEY, mSubInfoList.get(position).mSubId);
        startActivity(it);
    }
    ...
    private final BroadcastReceiver mSimStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(TelephonyIntents.ACTION_SIMINFO_UPDATED)) {
                ...
                List<SubInfoRecord> nowSubList = SubscriptionController
